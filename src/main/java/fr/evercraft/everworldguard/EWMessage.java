...
public class EWMessage extends EMessage<EverWorldGuard> {
	...
	public enum EWMessages implements EnumMessage {
		...
		PERMISSIONS_COMMANDS_MIGRATE("permissionsCommandsMigrate", ""),
		PERMISSIONS_COMMANDS_BYPASS("permissionsCommandsBypass", ""),
		PERMISSIONS_COMMANDS_CLEAR("permissionsCommandsClear", ""),
		PERMISSIONS_COMMANDS_SELECT_EXECUTE("permissionsCommandsSelectExecute", ""),
		PERMISSIONS_COMMANDS_SELECT_WAND("permissionsCommandsSelectWand", ""),
		PERMISSIONS_COMMANDS_SELECT_POS("permissionsCommandsSelectPos", ""),
		PERMISSIONS_COMMANDS_SELECT_EXPAND("permissionsCommandsSelectExpand", ""),
		PERMISSIONS_COMMANDS_SELECT_CUI("permissionsCommandsSelectCui", ""),
		PERMISSIONS_COMMANDS_REGION_EXECUTE("permissionsCommandsRegionExecute", ""),
		PERMISSIONS_COMMANDS_REGION_LOAD("permissionsCommandsRegionLoad", ""),
		PERMISSIONS_COMMANDS_REGION_FLAGS("permissionsCommandsRegionFlags", ""),
		PERMISSIONS_COMMANDS_REGION_CHECK("permissionsCommandsRegionCheck", ""),
		PERMISSIONS_COMMANDS_REGION_INFO_EXECUTE("permissionsCommandsRegionInfoExecute", ""),
		PERMISSIONS_COMMANDS_REGION_INFO_ITEM("permissionsCommandsRegionInfoItem", ""),
		PERMISSIONS_COMMANDS_REGION_INFO_OWNER("permissionsCommandsRegionInfoOwner", ""),
		PERMISSIONS_COMMANDS_REGION_INFO_MEMBER("permissionsCommandsRegionInfoMember", ""),
		PERMISSIONS_COMMANDS_REGION_INFO_REGIONS("permissionsCommandsRegionInfoRegions", ""),
		PERMISSIONS_COMMANDS_REGION_LIST_EXECUTE("permissionsCommandsRegionListExecute", ""),
		PERMISSIONS_COMMANDS_REGION_LIST_OTHERS("permissionsCommandsRegionListOthers", ""),
		PERMISSIONS_COMMANDS_REGION_DEFINE_EXECUTE("permissionsCommandsRegionDefineExecute", ""),
		PERMISSIONS_COMMANDS_REGION_DEFINE_TEMPLATE("permissionsCommandsRegionDefineTemplate", ""),
		PERMISSIONS_COMMANDS_REGION_REMOVE_EXECUTE("permissionsCommandsRegionRemoveExecute", ""),
		PERMISSIONS_COMMANDS_REGION_REMOVE_OWNER("permissionsCommandsRegionRemoveOwner", ""),
		PERMISSIONS_COMMANDS_REGION_REMOVE_MEMBER("permissionsCommandsRegionRemoveMember", ""),
		PERMISSIONS_COMMANDS_REGION_REMOVE_REGIONS("permissionsCommandsRegionRemoveRegions", ""),
		PERMISSIONS_COMMANDS_REGION_REDEFINE_EXECUTE("permissionsCommandsRegionRedefineExecute", ""),
		PERMISSIONS_COMMANDS_REGION_REDEFINE_OWNER("permissionsCommandsRegionRedefineOwner", ""),
		PERMISSIONS_COMMANDS_REGION_REDEFINE_MEMBER("permissionsCommandsRegionRedefineMember", ""),
		PERMISSIONS_COMMANDS_REGION_REDEFINE_REGIONS("permissionsCommandsRegionRedefineRegions", ""),
		PERMISSIONS_COMMANDS_REGION_RENAME_EXECUTE("permissionsCommandsRegionRenameExecute", ""),
		PERMISSIONS_COMMANDS_REGION_RENAME_OWNER("permissionsCommandsRegionRenameOwner", ""),
		PERMISSIONS_COMMANDS_REGION_RENAME_MEMBER("permissionsCommandsRegionRenameMember", ""),
		PERMISSIONS_COMMANDS_REGION_RENAME_REGIONS("permissionsCommandsRegionRenameRegions", ""),
		PERMISSIONS_COMMANDS_REGION_SELECT_EXECUTE("permissionsCommandsRegionSelectExecute", ""),
		PERMISSIONS_COMMANDS_REGION_SELECT_OWNER("permissionsCommandsRegionSelectOwner", ""),
		PERMISSIONS_COMMANDS_REGION_SELECT_MEMBER("permissionsCommandsRegionSelectMember", ""),
		PERMISSIONS_COMMANDS_REGION_SELECT_REGIONS("permissionsCommandsRegionSelectRegions", ""),
		PERMISSIONS_COMMANDS_REGION_FLAG_ADD_EXECUTE("permissionsCommandsRegionFlagAddExecute", ""),
		PERMISSIONS_COMMANDS_REGION_FLAG_ADD_OWNER("permissionsCommandsRegionFlagAddOwner", ""),
		PERMISSIONS_COMMANDS_REGION_FLAG_ADD_MEMBER("permissionsCommandsRegionFlagAddMember", ""),
		PERMISSIONS_COMMANDS_REGION_FLAG_ADD_REGIONS("permissionsCommandsRegionFlagAddRegions", ""),
		PERMISSIONS_COMMANDS_REGION_FLAG_REMOVE_EXECUTE("permissionsCommandsRegionFlagRemoveExecute", ""),
		PERMISSIONS_COMMANDS_REGION_FLAG_REMOVE_OWNER("permissionsCommandsRegionFlagRemoveOwner", ""),
		PERMISSIONS_COMMANDS_REGION_FLAG_REMOVE_MEMBER("permissionsCommandsRegionFlagRemoveMember", ""),
		PERMISSIONS_COMMANDS_REGION_FLAG_REMOVE_REGIONS("permissionsCommandsRegionFlagRemoveRegions", ""),
		PERMISSIONS_COMMANDS_REGION_OWNER_ADD_EXECUTE("permissionsCommandsRegionOwnerAddExecute", ""),
		PERMISSIONS_COMMANDS_REGION_OWNER_ADD_OWNER("permissionsCommandsRegionOwnerAddOwner", ""),
		PERMISSIONS_COMMANDS_REGION_OWNER_ADD_MEMBER("permissionsCommandsRegionOwnerAddMember", ""),
		PERMISSIONS_COMMANDS_REGION_OWNER_ADD_REGIONS("permissionsCommandsRegionOwnerAddRegions", ""),
		PERMISSIONS_COMMANDS_REGION_OWNER_REMOVE_EXECUTE("permissionsCommandsRegionOwnerRemoveExecute", ""),
		PERMISSIONS_COMMANDS_REGION_OWNER_REMOVE_OWNER("permissionsCommandsRegionOwnerRemoveOwner", ""),
		PERMISSIONS_COMMANDS_REGION_OWNER_REMOVE_MEMBER("permissionsCommandsRegionOwnerRemoveMember", ""),
		PERMISSIONS_COMMANDS_REGION_OWNER_REMOVE_REGIONS("permissionsCommandsRegionOwnerRemoveRegions", ""),
		PERMISSIONS_COMMANDS_REGION_MEMBER_ADD_EXECUTE("permissionsCommandsRegionMemberAddExecute", ""),
		PERMISSIONS_COMMANDS_REGION_MEMBER_ADD_OWNER("permissionsCommandsRegionMemberAddOwner", ""),
		PERMISSIONS_COMMANDS_REGION_MEMBER_ADD_MEMBER("permissionsCommandsRegionMemberAddMember", ""),
		PERMISSIONS_COMMANDS_REGION_MEMBER_ADD_REGIONS("permissionsCommandsRegionMemberAddRegions", ""),
		PERMISSIONS_COMMANDS_REGION_MEMBER_REMOVE_EXECUTE("permissionsCommandsRegionMemberRemoveExecute", ""),
		PERMISSIONS_COMMANDS_REGION_MEMBER_REMOVE_OWNER("permissionsCommandsRegionMemberRemoveOwner", ""),
		PERMISSIONS_COMMANDS_REGION_MEMBER_REMOVE_MEMBER("permissionsCommandsRegionMemberRemoveMember", ""),
		PERMISSIONS_COMMANDS_REGION_MEMBER_REMOVE_REGIONS("permissionsCommandsRegionMemberRemoveRegions", ""),
		PERMISSIONS_COMMANDS_REGION_SETPARENT_EXECUTE("permissionsCommandsRegionSetparentExecute", ""),
		PERMISSIONS_COMMANDS_REGION_SETPARENT_OWNER("permissionsCommandsRegionSetparentOwner", ""),
		PERMISSIONS_COMMANDS_REGION_SETPARENT_MEMBER("permissionsCommandsRegionSetparentMember", ""),
		PERMISSIONS_COMMANDS_REGION_SETPARENT_REGIONS("permissionsCommandsRegionSetparentRegions", ""),
		PERMISSIONS_COMMANDS_REGION_SETPRIORITY_EXECUTE("permissionsCommandsRegionSetpriorityExecute", ""),
		PERMISSIONS_COMMANDS_REGION_SETPRIORITY_OWNER("permissionsCommandsRegionSetpriorityOwner", ""),
		PERMISSIONS_COMMANDS_REGION_SETPRIORITY_MEMBER("permissionsCommandsRegionSetpriorityMember", ""),
		PERMISSIONS_COMMANDS_REGION_SETPRIORITY_REGIONS("permissionsCommandsRegionSetpriorityRegions", ""),
		PERMISSIONS_COMMANDS_REGION_TELEPORT_EXECUTE("permissionsCommandsRegionTeleportExecute", ""),
		PERMISSIONS_COMMANDS_REGION_TELEPORT_SPAWN("permissionsCommandsRegionTeleportSpawn", ""),
		PERMISSIONS_COMMANDS_REGION_TELEPORT_OWNER("permissionsCommandsRegionTeleportOwner", ""),
		PERMISSIONS_COMMANDS_REGION_TELEPORT_MEMBER("permissionsCommandsRegionTeleportMember", ""),
		PERMISSIONS_COMMANDS_REGION_TELEPORT_REGIONS("permissionsCommandsRegionTeleportRegions", ""),
		PERMISSIONS_FLAGS("permissionsFlags", "");
