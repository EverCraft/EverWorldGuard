...
public class EWMessage extends EMessage<EverWorldGuard> {
	...
	public enum EWMessages implements EnumMessage {
		...
		MIGRATE_SQL_LOG("migrate.sqlLog", 					"Les données ont bien été transférées dans la base de données."),
		MIGRATE_CONF("migrate.conf", 						"&7Les données ont bien été transférées dans les fichiers de configurations."),
		MIGRATE_CONF_LOG("migrate.confLog", 				"Les données ont bien été transférées dans les fichiers de configurations."),
		...
		CLEAR_DESCRIPTION("clear.description",							"Transfère les données"),
		CLEAR_CONFIRMATION("clear.confirmation", 						"&7Souhaitez-vous vraiment transférer les données dans une base de données &6SQL&7 ? <confirmation>"),
		CLEAR_CONFIRMATION_VALID("clear.confirmationValid", 			"&2&n[Confirmer]"),
		CLEAR_CONFIRMATION_VALID_HOVER("clear.confirmationValidHover", 	"&cCliquez ici pour réaliser le transfert"),
		CLEAR_PLAYER("clear.player", 			"&7Les données ont bien été transférées dans la base de données."),
		CLEAR_LOG("clear.log", 					"Les données ont bien été transférées dans la base de données."),
