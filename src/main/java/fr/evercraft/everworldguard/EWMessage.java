...
public class EWMessage extends EMessage<EverWorldGuard> {
	...
	public enum EWMessages implements EnumMessage {
		...
		TRANSFERT_DESCRIPTION("transfert.description",									"Transfère les données"),
		TRANSFERT_SQL_CONFIRMATION("transfert.sqlConfirmation", 						"&7Souhaitez-vous vraiment transférer les données dans une base de données &6SQL&7 ? <confirmation>"),
		TRANSFERT_SQL_CONFIRMATION_VALID("transfert.sqlConfirmationValid", 				"&2&n[Confirmer]"),
		TRANSFERT_SQL_CONFIRMATION_VALID_HOVER("transfert.sqlConfirmationValidHover", 	"&cCliquez ici pour réaliser le transfert"),
		TRANSFERT_CONF_CONFIRMATION("transfert.confConfirmation", 	"&7Souhaitez-vous vraiment transférer les données dans des &6fichiers de configuration&7 ? <confirmation>"),
		TRANSFERT_CONF_CONFIRMATION_VALID("transfert.confConfirmationValid", 			"&2&n[Confirmer]"),
		TRANSFERT_CONF_CONFIRMATION_VALID_HOVER("transfert.confConfirmationValidHover", "&cCliquez ici pour réaliser le transfert"),
		TRANSFERT_SQL("transfert.sql", 							"&7Les données ont bien été transférées dans la base de données."),
		TRANSFERT_SQL_LOG("transfert.sqlLog", 					"Les données ont bien été transférées dans la base de données."),
		TRANSFERT_CONF("transfert.conf", 						"&7Les données ont bien été transférées dans les fichiers de configurations."),
		TRANSFERT_CONF_LOG("transfert.confLog", 				"Les données ont bien été transférées dans les fichiers de configurations."),
		TRANSFERT_DISABLE("transfert.disable", 					"&cErreur : Vous devez être connecté à une base de données pour faire le transfert des données."),
