...
public class FlagExplosion extends EntityTemplateFlag {
	
	private final EverWorldGuard plugin;
	
	public FlagExplosion(EverWorldGuard plugin) {
		super("EXPLOSION");
	...
	public void onDetonateExplosivePlayer(DetonateExplosiveEvent event, WorldGuardWorld world, Player player) {
		if (this.getDefault().contains(event.getTargetEntity()) && 
			...
			// TODO Cancel : https://github.com/SpongePowered/SpongeCommon/issues/1366
			event.getExplosionBuilder()
