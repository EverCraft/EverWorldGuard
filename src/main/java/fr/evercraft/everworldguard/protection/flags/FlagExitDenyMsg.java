...
public class FlagExitDenyMsg extends MessageFlag {
	
	public FlagExitDenyMsg(EverWorldGuard plugin) {
		super(plugin, "EXIT_DENY_MSG");
	}
	
	@Override
	public String getDescription() {
		return EWMessages.FLAG_EXIT_DENY_MESSAGE_DESCRIPTION.getString();
	}

	@Override
	public EMessageBuilder getDefault() {
		return EWMessages.FLAG_EXIT_DENY_MESSAGE_DEFAULT.getBuilder();
	}
