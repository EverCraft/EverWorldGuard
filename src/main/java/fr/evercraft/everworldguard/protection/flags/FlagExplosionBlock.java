...
public class FlagExplosionBlock extends EntityTemplateFlag {
	
	private final EverWorldGuard plugin;
	
	public FlagExplosionBlock(EverWorldGuard plugin) {
		super("EXPLOSION_BLOCK");
	...
	public String getDescription() {
		return EWMessages.FLAG_EXPLOSION_BLOCK_DESCRIPTION.getString();
	}
