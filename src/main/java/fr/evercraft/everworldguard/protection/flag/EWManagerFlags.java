...
public class EWManagerFlags {
	...
	public final FlagEntryMsg ENTRY_MESSAGE;
	public final FlagEntryDenyMsg ENTRY_DENY_MESSAGE;
	public final FlagExit EXIT;
	public final FlagExitMsg EXIT_MESSAGE;
	public final FlagExitDenyMsg EXIT_DENY_MESSAGE;
	...
	public final FlagKeepInventory INVENTORY_DROP;
	...
	public EWManagerFlags(EverWorldGuard plugin) {
		...
		INVENTORY_DROP = new FlagKeepInventory(this.plugin);
